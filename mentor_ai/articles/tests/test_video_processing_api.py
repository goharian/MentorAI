...
from articles.models import Mentor, VideoContent
...
class VideoProcessingApiTests(APITestCase):
    ...
    @mock.patch("articles.views.process_video_transcript_task.delay")
    ...
    @mock.patch("articles.views.process_video_transcript_task.delay", side_effect=RuntimeError("broker down"))
